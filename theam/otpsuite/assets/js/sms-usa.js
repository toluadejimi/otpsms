...
$(document).ready(function () {
    ...
    $("#service-id").change(function () {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                var html = "<div class='pool-container'>";
                ...
                pools.forEach(function(pool){
                    ...
                    <div class="pool-card" data-pool="${pool.pool}">
                        ...
                        <div class="pool-price">₦${pool.price_naira}</div>
                ...
                $("#pricing-information-view").html(html);
            }
        });
    });
    ...
    $(document).on("click",".pool-card",function(){
