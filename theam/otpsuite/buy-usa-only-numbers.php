...
<script type="module" src="<?php echo WEBSITE_URL; ?>/theam/otpsuite/assets/js/sms-usa-only.js?v=232412"></script>
<script src="<?php echo WEBSITE_URL; ?>/theam/otpsuite/assets/js/main-usa-only.js?v=23212121"></script>
