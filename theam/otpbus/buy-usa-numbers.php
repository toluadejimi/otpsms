...
<!-- Searchable -->
<div class="border bg-white rounded dark:bg-[#1b2e4b] dark:border-0 shadow-sm mb-5">
    <div style="outline: 8px ridge rgba(17, 50, 220, 0.6);
    border-radius: 2rem;width 10px;" <!--="" whatsapp="" <a="" href="https://whatsapp.com/channel/0029VbB96hpAO7RJnV3xYa2K" target="_blank" class="text-center shadow p-2">
           <!-- <div class="text-4xl grid place-content-center w-16 h-16 rounded-md bg-green-100 text-green-600 dark:bg-green-800 dark:text-green-200">
                <i fa fa-whatsapp"></i>
            </div>
            <small class="text-sm text-success block mt-2">Contact us on WhatsApp</small>
        </a>-->

        <!-- Telegram -->
        <a href="https://whatsapp.com/channel/0029VbB96hpAO7RJnV3xYa2K" target="_blank" class="shadow p-2 text-center">
           <!-- <div class="text-4xl grid place-content-center w-16 h-16 rounded-md bg-blue-100 text-blue-600 dark:bg-blue-800 dark:text-blue-200">
                <i class="bi bi-telegram text-primary"></i>
            </div>-->
            <small class="text-sm text-primary block mt-2">Join us on WhatsApp, telegram got ban</small>
        </a>
    </div>
</div>
<div class="panel buy-number-panel mt-2 dark:bg-[#1b2e4b] dark:border-0">
  ...
  <div class="flex items-center justify-between mb-5">
    <h5 class="font-semibold text-lg dark:text-white-light">Buy USA Numbers</h5>
       ...
       <option value="">Select Server</option>
             <?php
                ...
                foreach($countries as $country){
                  echo "<option value=".$country['id']." selected>" . $country['server_name'] ."</option>";
                  $count++;
                }
              ?>
     </select>
...
<div id="services-loader" class="my-3 text-center hidden">
  ...
  <div id="number-count-loader" class="my-1 number-count-loader hidden"></div>
  <p id="available-numbers-count" class="dark:text-white-light"></p>
  <div class="mt-5">
...
<!--<center>-->
<!--    <h6 style="color: red"> Don't Use WhatsApp Business For Any Of Our Number!!! </h6>-->
<!--    </center>-->
        ...
        <div x-show="active === 1" x-collapse="" style="display: none; height: 0px; overflow: hidden;" hidden="">
            <div class="p-3 font-semibold">
                ...
                <p class="p-2 text-[#515365] dark:text-white-light">
                    If you don't receive any otp/code after 2-7 mins Cancel The Number..
                    Always Cancel the number if you did not Receive Code
                </p>
                <p>
                        ...
                        <p class="p-2 text-[#515365] dark:text-white-light">
                           <p style="color:#408EE0"><strong>Telegram Tips: </strong></p>
                                ...
                                ● 50/50 to receive code on telegram numbers.<ul>
                                    <ul>● Make Use Of Vpn when you purchase Telegram numbers</ul>
...
<script src="js/main-usa.js?v=554485311"></script>
<script type="module" src="js/sms-usa.js?v=057"></script>
<script src="js/xy.js?v=22930"></script>
