...
$data = mysqli_fetch_assoc(
    mysqli_query($conn,"SELECT * FROM electricity_providers WHERE id='$id'")
);
?>
<!DOCTYPE html>
<html>
...
<head>
    <title>Edit Electricity Provider</title>
...
<body id="page-top">
                            ...
                            <div class="card" id="loading">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="disco_id" value="<?= $data['disco_id']; ?>" class="form-control">
                                    </div>
    ...
    <script>
        $("#update").click(function() {
            ...
            $.post("ajax/edit_electricity.php", {
                id: $("#id").val(),
                name: $("#name").val(),
            ...
            .done(function() {
                Notiflix.Notify.Success('Electricity provider updated successfully!');
            })
            .fail(function() {
