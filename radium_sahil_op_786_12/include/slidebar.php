    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="OTPSUITE.png">
        </div>
        <div class="sidebar-brand-text mx-3">OTPSUITE</div>
      </a>
   ...
   <li class="nav-item" id="show_notifications">
      ...
      <li class="nav-item" id="boosting_api_home">
        <a class="nav-link" href="boosting_api_home">
          ...
          <span>Show Boosting Panel</span></a>
      </li>
      <li class="nav-item" id="telegram_api_home">
        <a class="nav-link" href="telegram_api_home">
          <i class="fas fa-fw fa-phone-square"></i>
          <span>Show Telegram Panel</span></a>
      </li>
       <li class="nav-item" id="show_log_categories">
        <a class="nav-link" href="show_log_categories">
          <i class="fas fa-fw fa-phone-square"></i>
          <span>Show Logs Categories</span></a>
      </li>
      <li class="nav-item" id="show_log_products">
        <a class="nav-link" href="show_log_products">
          <i class="fas fa-fw fa-phone-square"></i>
          <span>Show Log Products</span></a>
      </li>
      <li class="nav-item" id="show_log_orders">
        <a class="nav-link" href="show_log_orders">
          <i class="fas fa-fw fa-phone-square"></i>
          <span>Show Log Orders</span></a>
      </li>
      <li class="nav-item" id="show_vtu_management">
        <a class="nav-link" href="show_vtu_management">
          <i class="fas fa-fw fa-phone-square"></i>
          <span>Show VTU Management</span></a>
      </li>
    ...
    <li class="nav-item" id="upi_transaction">
     ...
     <li class="nav-item" id="refer_transaction">
      ...
      <li class="nav-item" id="payment_gateways">
        <a class="nav-link " href="payment_gateways">
