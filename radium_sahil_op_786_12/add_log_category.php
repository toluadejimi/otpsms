...
<head>
    <title>Add Log Category - @radiumsahil</title>
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add Log Catgeory</li>
                        </ol>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="updateProductForm">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" min="0" value="0" id="priority">
                                        ...
                                        <button type="button" id="update" class="btn btn-primary w-100 mb-2">Add Category</button>
                                    </form>
                                </div>
