    ...
    $data = mysqli_query($conn, "SELECT * FROM networks ORDER BY id DESC");
    ?>
    <!DOCTYPE html>
    <html>
                                                ...
                                                <table class="table align-items-center table-flush" id="dataTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php while ($row = mysqli_fetch_assoc($data)) { ?>
                                                            <tr>
                                                                <td><?= $row['name']; ?></td>
                                                                <td><?= $row['api_network_id']; ?></td>
                                                                <!-- <td><a href="edit_network?id=<?= $row['id']; ?>" class="btn btn-sm btn-primary">Edit</a></td> -->
                                                                <!-- <td>
                                                                    <form method="post">
    ...
    if (isset($_POST['delete'])) {
        mysqli_query($conn, "DELETE FROM networks WHERE id='" . $_POST['id'] . "'");
