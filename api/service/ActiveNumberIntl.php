...
$user_id = $check_token;
$sql = "SELECT active_number.*, otp_server.api_id AS api_id FROM active_number INNER JOIN otp_server ON active_number.server_id = otp_server.id WHERE active_number.user_id = '" . $user_id . "' AND active_number.active_status = '2' AND otp_server.api_id = '25' ORDER BY active_number.id DESC";
